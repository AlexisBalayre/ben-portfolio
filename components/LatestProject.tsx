...
const LatestProject = () => {
  ...
  return (
    <motion.section
      className="w-full bg-base-content py-14 px-6 md:px-16 group section-avec-trait"
      variants={fadeUp}
      initial="hidden"
      whileInView="visible"
    ...
    >
      <div className="max-w-4xl mx-auto flex flex-col items-center gap-10 md:gap-12">
        ...
        <div className="w-full text-center flex flex-col items-center">
          <motion.h2
            className="text-3xl md:text-5xl font-bold text-base-100/80 transition-all duration-500 group-hover:text-base-100 group-hover:-translate-y-1 mb-2"
          ...
          <motion.p
            className="text-base-100/70 text-lg leading-relaxed max-w-2xl"
