...
export const Footer = () => {
  ...
  return (
    <footer className="bg-[#0c0c0c] text-white/60 py-8 sm:py-12 px-4 sm:px-6" id="contact">
      <div className="max-w-5xl mx-auto flex flex-col items-center gap-8">

        {/* Name */}
        <p className="text-white font-semibold tracking-wide text-base sm:text-lg">Benjamin Balayre</p>

        {/* Contact */}
        <address className="not-italic flex flex-col sm:flex-row gap-2 sm:gap-8 items-center text-sm">
          <a
            href="tel:+33782347644"
            rel="noopener noreferrer"
            className="flex items-center gap-2 hover:text-white transition-colors duration-200 px-3 py-2 min-h-[44px]"
