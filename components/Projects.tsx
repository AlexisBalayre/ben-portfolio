...
const Projects = () => {
    ...
    return (
        <div className="relative w-full min-h-[400px] sm:min-h-[480px] md:min-h-[580px] overflow-hidden flex items-center justify-center">
            ...
            {/* Content */}
            <div className="relative z-10 text-center px-4 sm:px-8 md:px-20 py-14 sm:py-20 max-w-2xl mx-auto">
